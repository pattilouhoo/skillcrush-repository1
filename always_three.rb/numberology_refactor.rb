...
def select_message(birthpath_num)
	case birthpath_num
	when 1
    puts "Your numerology number is #{birthpath_num}.\nOne is the leader. The number one indicates the ability to stand alone, and is a strong vibration. Ruled by the Sun."
when 2
...
birthpath_num = make_birthpath(birthday)
message = select_message(birthpath_num)
puts message
